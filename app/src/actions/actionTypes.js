...
export const SUCCESS_SENDING_MESSAGE = 'SENDING_MESSAGE';
export const FAIL_SENDING_MESSAGE = 'SENDING_MESSAGE';

export const GETTING_MESSAGES = 'GETTING_MESSAGES'
export const SUCCESS_GETTING_MESSAGES = 'GETTING_MESSAGES'
export const FAIL_GETTING_MESSAGES = 'GETTING_MESSAGES'
